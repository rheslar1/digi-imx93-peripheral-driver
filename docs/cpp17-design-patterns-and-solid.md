...
```bash
./build/digi_connectcore_i_mx93_peripheral_driver --nominal
./build/digi_connectcore_i_mx93_peripheral_driver --unsafe
./build/digi_connectcore_i_mx93_peripheral_driver --offline
```
