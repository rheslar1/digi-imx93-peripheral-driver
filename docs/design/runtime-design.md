# Digi ConnectCore i.MX93 Peripheral Driver Runtime Design
...
1. Build a runtime profile for `digi-imx93-peripheral-driver`.
...
The runtime must make this focus measurable through logs, reports, tests, diagrams, or hardware captures. The proof point for review is: Board-specific bring-up, clean driver/application separation, register-level reasoning, and testable hardware abstractions.
