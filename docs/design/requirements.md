...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Digi ConnectCore i.MX93 Peripheral Driver. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Hardware peripheral driver for the Digi ConnectCore i.MX93 EVK, covering an on-chip SPI or PWM block, application layer, and test boundary. | Scenario tests and documentation review. |
