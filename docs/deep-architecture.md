# Digi ConnectCore i.MX93 Peripheral Driver Deep Architecture
...
C++17, C++ Design Patterns, SOLID, i.MX93, Digi ConnectCore, SPI/PWM, Device tree, Linux driver, Unit tests
